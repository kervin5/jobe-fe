...
// import classes from './ThumbsUp.module.scss';

const thumbsUp = () => {
    return (<div className={"ThumbsUpIcon"}>
    ...
    .ThumbsUpIcon {
      ...
      .ThumbsUpIcon .stripes {
        fill: #f7f7f7;
        animation: stripesSwing 1300ms ease-in-out;
      }
      .ThumbsUpIcon .stars {
        fill: #febb02;
      }
      .ThumbsUpIcon .star1 {
        animation: starFly1 1300ms;
        z-index: 1;
      }
      .ThumbsUpIcon .star2 {
        animation: starFly2 1300ms;
        z-index: 1;
      }
      .ThumbsUpIcon .star3 {
        animation: starFly3 1300ms;
        z-index: 1;
      }
      .ThumbsUpIcon .star4 {
        animation: starFly4 1300ms;
        z-index: 1;
      }
      .ThumbsUpIcon .star5 {
        animation: starFly5 1300ms;
        z-index: 1;
      }
      .ThumbsUpIcon .ThumbsUp {
        animation: thumbsupShake 1300ms ease-in-out;
        z-index: 2;
      }
      @keyframes starFly1 {
        0% {
